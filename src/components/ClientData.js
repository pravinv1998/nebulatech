...
const ClientData = () => {
  return (
    <div className=" flex flex-wrap items-center justify-around p-4 w-full h-64 bg-transparent">
      <div
        data-aos="fade-right"
        className="flex shadow-lg bg-secondry text-sky-100 hover:text-gray-900 hover:bg-transparent animate-bounce shadow-slate-500/30 rounded-3xl p-4  flex-col items-start  justify-center flex-wrap "
      >
      ...
      <div
        data-aos="fade-up"
        className="flex shadow-lg bg-secondry text-gray-100 hover:text-gray-900 hover:bg-transparent animate-bounce shadow-slate-500/30 rounded-3xl p-4  flex-col items-start justify-center flex-wrap "
      >
