      ...
      <div className="flex flex-col md:flex-row items-start  md:items-center justify-around space-y-8 px-10 py-10">
        <div className="w-full md:w-3/4">
          <div className="w-full md:w-3/4">
            ...
            <div className="w-full shadow-lg shadow-slate-400/50  rounded-md backdrop-blur-sm bg-slate-700/30 mt-4 space-y-2 p-2 ">
            ...
            <div className=" shadow-xl shadow-slate-400/50 w-full rounded-md backdrop-blur-sm bg-slate-700/30 mt-4 space-y-2 p-2 ">
        ...
        <div className="w-full shadow-lg shadow-slate-400/50">
          <iframe
