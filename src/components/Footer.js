...
const Footer = () => {
  ...
  return (
    <div className="flex flex-col text-cyan-50 bg-primary/40 text-1xl ">
      <div className="flex flex-col md:flex-row items-start  md:items-center justify-around space-y-8 px-10 py-10">
        <div className="w-full md:w-3/4">
          <div className="w-full text-slate-100 md:w-3/4">
            ...
            <div className="w-full shadow-lg  shadow-slate-500/50  rounded-md  bg-slate-500/30 mt-4 space-y-2 p-2 ">
        ...
        <div className="w-full shadow-lg shadow-slate-500/50">
          <iframe
